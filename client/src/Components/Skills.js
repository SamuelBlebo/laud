...
export default function Skills() {
  return (
    <div className="p-[40px] lg:flex  md:px-[110px] lg:px-[60px] xl:px-[150px] 2xl:px-[300px]">
      ...
      <div className="flex justify-center mt-[50px] lg:flex-1">
        <div className="flex-1">
          <div className="lg:flex-1 mt-[20px]  ">
            <div className="flex justify-center items-center bg-[#F7F7F7] hover:bg-[#E5540A] rounded-[20px] h-[120px] w-[120px] drop-shadow-2xl">
              <img
                src={CSharp}
                alt=" C-sharp logo"
